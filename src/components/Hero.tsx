...
const Hero = () => {
  return (
    <div className="p-4 flex-col sm:flex sm:flex-row sm:justify-items-center  sm:my-6">
      <div className="pb-6 sm:py-10 max-w-[65%]">
        ...
        <button className="px-4 py-3 bg-slate-900 text-white rounded-full hover:bg-sky-500">
